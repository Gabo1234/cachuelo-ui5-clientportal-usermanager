		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#clientportalsaasacompeusermanager-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"clientportalsaasacompeusermanager-display": {
								"semanticObject": "clientportalsaasacompeusermanager",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=clientportal.saasa.com.pe.usermanager",
									"url": sap.ui.require.toUrl("clientportal/saasa/com/pe/usermanager")
								}
							}
						}
					}
